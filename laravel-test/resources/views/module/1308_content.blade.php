<div class="container container-1308">
    <div class="card-deck">
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <span class="logo-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="84.032" height="23.52"
                        ...
                        <path
                            ...
                            transform="translate(-2.336 23.04)"></path>
                        </svg>
                    </span>
                </div>
                <p class="card-text">Razzi is more than a leading retailer of home decor and gifts. We help our customers create the backdrop for memorable life events</p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">CUSTOMER SERVICES</h6>
                <ul class="card-text">
