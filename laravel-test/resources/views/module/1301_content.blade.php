<div class="container container-1301">
            ...
            <div class="nav collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown li-menu">
                        ...
                        <ul class="dropdown-menu itm" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="home">Home1</a></li>
                ...
                <div class="logo">
                    <span class="logo-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="84.032" height="23.52" viewBox="0 0 84.032 23.52">
                ...
                <div class="icon-nav d-flex">
                    <div class="icon-search">
                        <span class="razzi-svg-icon "><svg aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="icon-cart">
                        ...
                        <div class="title">
                            <a href="cart">
                                <span class="razzi-svg-icon icon-cart"><svg aria-hidden="true" role="img" focusable="false" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <svg>
